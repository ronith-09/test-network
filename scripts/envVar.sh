...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_BETWEEN_CA
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_BANK1_CA
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/bank1organization.example.com/users/Admin@bank1organization.example.com/msp
