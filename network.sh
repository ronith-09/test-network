...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cryptogen" ]; then
    ...
    infoln "Creating BetweenOrganization Identities"
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.betweenorganization.example.com betweenorganization
    peer_cert peer peer0.bank1organization.example.com bank1organization
